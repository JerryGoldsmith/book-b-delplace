...
export class AService {
  ...
  public saveTotalA(): void {
    ...
    .on('value', (snapshot) => {
      ...
      //   data.push(["isChecked=" + this.priceAs[key].isChecked, "value=" + this.priceAs[key].value, "label=" + this.priceAs[key].label]);
      // });

      // let data = [];
      //   Object.keys(this.totalAs).forEach((key) => {
      //   data.push(["name=" + this.totalAs[key].name, "timestamp=" + this.totalAs[key].timestamp]);
      // });

      // console.log(data[0]);

      // console.log("saveTotalA" + newPost + data + postId);
      // return newPost + data + postId; // object to data > postId

      // convert object > array
      
      // var finalPost = {};
      // finalPost = postsRef.set(this.totalAs);
      //   // updates = Object.keys(this.totalAs).map(index => {
      //   //     let totalA = this.totalAs[index];
      //   //     console.log(totalA);
      //   //     return totalA;
      //   //   });
      // console.log(finalPost);
      // newPostRef.update(finalPost);
      // return finalPost;
