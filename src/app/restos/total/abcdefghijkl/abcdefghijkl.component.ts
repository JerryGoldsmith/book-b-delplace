...
@Component({
  selector: 'app-abcdefghijkl',
  templateUrl: './abcdefghijkl.component.html',
  styleUrls: [
...
export class AbcdefghijklComponent implements OnInit {
  ...
  get totalAs(): Array<any> {
    return (Object as any).values(this.aService.totalAs);
  }

  get totalBs(): Array<any> {
    return (Object as any).values(this.bService.totalBs);
  }

  get totalCs(): Array<any> {
    return (Object as any).values(this.cService.totalCs);
  }

  get totalDs(): Array<any> {
    return (Object as any).values(this.dService.totalDs);
  }

  get totalEs(): Array<any> {
    return (Object as any).values(this.eService.totalEs);
  }

  get totalFs(): Array<any> {
    return (Object as any).values(this.fService.totalFs);
  }

  get totalGs(): Array<any> {
    return (Object as any).values(this.gService.totalGs);
  }

  get totalHs(): Array<any> {
    return (Object as any).values(this.hService.totalHs);
  }

  get totalIs(): Array<any> {
    return (Object as any).values(this.iService.totalIs);
  }

  get totalJs(): Array<any> {
    return (Object as any).values(this.jService.totalJs);
  }

  get totalKs(): Array<any> {
    return (Object as any).values(this.kService.totalKs);
  }

  get totalLs(): Array<any> {
    return (Object as any).values(this.lService.totalLs);
  }
  ...
  onSaveTotalDeleteAOnFirebase() {
    this.aService.saveTotalDeleteA();
  }

  onSaveTotalDeleteBOnFirebase() {
    this.bService.saveTotalDeleteB();
  }

  onSaveTotalDeleteCOnFirebase() {
    this.cService.saveTotalDeleteC();
  }

  onSaveTotalDeleteDOnFirebase() {
    this.dService.saveTotalDeleteD();
  }

  onSaveTotalDeleteEOnFirebase() {
    this.eService.saveTotalDeleteE();
  }

  onSaveTotalDeleteFOnFirebase() {
    this.fService.saveTotalDeleteF();
  }

  onSaveTotalDeleteGOnFirebase() {
    this.gService.saveTotalDeleteG();
  }

  onSaveTotalDeleteHOnFirebase() {
    this.hService.saveTotalDeleteH();
  }

  onSaveTotalDeleteIOnFirebase() {
    this.iService.saveTotalDeleteI();
  }

  onSaveTotalDeleteJOnFirebase() {
    this.jService.saveTotalDeleteJ();
  }

  onSaveTotalDeleteKOnFirebase() {
    this.kService.saveTotalDeleteK();
  }

  onSaveTotalDeleteLOnFirebase() {
    this.lService.saveTotalDeleteL();
  }

  // -----

  onSaveTotalCompleteDeleteAOnFirebase() {
    this.aService.saveTotalCompleteDeleteA();
  }

  onSaveTotalCompleteDeleteBOnFirebase() {
    this.bService.saveTotalCompleteDeleteB();
  }

  onSaveTotalCompleteDeleteCOnFirebase() {
    this.cService.saveTotalCompleteDeleteC();
  }

  onSaveTotalCompleteDeleteDOnFirebase() {
    this.dService.saveTotalCompleteDeleteD();
  }

  onSaveTotalCompleteDeleteEOnFirebase() {
    this.eService.saveTotalCompleteDeleteE();
  }

  onSaveTotalCompleteDeleteFOnFirebase() {
    this.fService.saveTotalCompleteDeleteF();
  }

  onSaveTotalCompleteDeleteGOnFirebase() {
    this.gService.saveTotalCompleteDeleteG();
  }

  onSaveTotalCompleteDeleteHOnFirebase() {
    this.hService.saveTotalCompleteDeleteH();
  }

  onSaveTotalCompleteDeleteIOnFirebase() {
    this.iService.saveTotalCompleteDeleteI();
  }

  onSaveTotalCompleteDeleteJOnFirebase() {
    this.jService.saveTotalCompleteDeleteJ();
  }

  onSaveTotalCompleteDeleteKOnFirebase() {
    this.kService.saveTotalCompleteDeleteK();
  }

  onSaveTotalCompleteDeleteLOnFirebase() {
    this.lService.saveTotalCompleteDeleteL();
  }

  // -----

  onSaveTotalTvaDeleteAOnFirebase() {
    this.aService.saveTotalTvaDeleteA();
  }

  onSaveTotalTvaDeleteBOnFirebase() {
    this.bService.saveTotalTvaDeleteB();
  }

  onSaveTotalTvaDeleteCOnFirebase() {
    this.cService.saveTotalTvaDeleteC();
  }

  onSaveTotalTvaDeleteDOnFirebase() {
    this.dService.saveTotalTvaDeleteD();
  }

  onSaveTotalTvaDeleteEOnFirebase() {
    this.eService.saveTotalTvaDeleteE();
  }

  onSaveTotalTvaDeleteFOnFirebase() {
    this.fService.saveTotalTvaDeleteF();
  }

  onSaveTotalTvaDeleteGOnFirebase() {
    this.gService.saveTotalTvaDeleteG();
  }

  onSaveTotalTvaDeleteHOnFirebase() {
    this.hService.saveTotalTvaDeleteH();
  }

  onSaveTotalTvaDeleteIOnFirebase() {
    this.iService.saveTotalTvaDeleteI();
  }

  onSaveTotalTvaDeleteJOnFirebase() {
    this.jService.saveTotalTvaDeleteJ();
  }

  onSaveTotalTvaDeleteKOnFirebase() {
    this.kService.saveTotalTvaDeleteK();
  }

  onSaveTotalTvaDeleteLOnFirebase() {
    this.lService.saveTotalTvaDeleteL();
  }
