...
@Component({
  selector: 'app-reservation-home-confirm',
  templateUrl: './reservation-home-confirm.component.html',
  styleUrls: ['./reservation-home-confirm.component.scss',
  './../normalize.component.scss']
})
export class ReservationHomeConfirmComponent implements OnInit {
